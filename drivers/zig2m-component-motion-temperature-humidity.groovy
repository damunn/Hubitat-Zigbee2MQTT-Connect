/**
 * ====================  zig2m Component Motion/Temperature Driver ==========================
 * 
...
metadata {
   definition(name: "zig2m Component Motion/Temperature/Humidity Sensor", namespace: "Zigbee2MQTT", author: "Robert Morris", component: true) {
      capability "Sensor"
      capability "Battery"
